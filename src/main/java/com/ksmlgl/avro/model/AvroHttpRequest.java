...
public class AvroHttpRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8437886908572092646L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroHttpRequest\",\"namespace\":\"com.ksmlgl.avro.model\",\"fields\":[{\"name\":\"requestTimes\",\"type\":\"long\"},{\"name\":\"clientIdentifier\",\"type\":{\"type\":\"record\",\"name\":\"ClientIdentifier\",\"fields\":[{\"name\":\"hostName\",\"type\":\"string\"},{\"name\":\"ipAddress\",\"type\":\"string\"}]}},{\"name\":\"employeeNames\",\"type\":{\"type\":\"array\",\"items\":\"string\"},\"default\":null},{\"name\":\"active\",\"type\":{\"type\":\"enum\",\"name\":\"Active\",\"symbols\":[\"YES\",\"NO\"]}}]}");
  ...
  @Deprecated public long requestTimes;
  @Deprecated public com.ksmlgl.avro.model.ClientIdentifier clientIdentifier;
  @Deprecated public java.util.List<java.lang.CharSequence> employeeNames;
  @Deprecated public com.ksmlgl.avro.model.Active active;
   ...
   * @param requestTimes The new value for requestTimes
   * @param clientIdentifier The new value for clientIdentifier
   * @param employeeNames The new value for employeeNames
   * @param active The new value for active
   */
  public AvroHttpRequest(java.lang.Long requestTimes, com.ksmlgl.avro.model.ClientIdentifier clientIdentifier, java.util.List<java.lang.CharSequence> employeeNames, com.ksmlgl.avro.model.Active active) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: requestTimes = (java.lang.Long)value$; break;
    case 1: clientIdentifier = (com.ksmlgl.avro.model.ClientIdentifier)value$; break;
    case 2: employeeNames = (java.util.List<java.lang.CharSequence>)value$; break;
    case 3: active = (com.ksmlgl.avro.model.Active)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }

  /**
   * Gets the value of the 'requestTimes' field.
   * @return The value of the 'requestTimes' field.
   */
  public java.lang.Long getRequestTimes() {
    return requestTimes;
  }

  /**
   * Sets the value of the 'requestTimes' field.
   * @param value the value to set.
   */
  public void setRequestTimes(java.lang.Long value) {
   ...
   */
  public com.ksmlgl.avro.model.ClientIdentifier getClientIdentifier() {
   ...
   * @param value the value to set.
   */
  public void setClientIdentifier(com.ksmlgl.avro.model.ClientIdentifier value) {
   ...
   */
  public com.ksmlgl.avro.model.Active getActive() {
    return active;
  }
   ...
   * @param value the value to set.
   */
  public void setActive(com.ksmlgl.avro.model.Active value) {
    this.active = value;
  }
   ...
   */
  public static com.ksmlgl.avro.model.AvroHttpRequest.Builder newBuilder() {
    return new com.ksmlgl.avro.model.AvroHttpRequest.Builder();
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.ksmlgl.avro.model.AvroHttpRequest.Builder newBuilder(com.ksmlgl.avro.model.AvroHttpRequest.Builder other) {
    return new com.ksmlgl.avro.model.AvroHttpRequest.Builder(other);
  }
   ...
   * @return A new AvroHttpRequest RecordBuilder
   */
  public static com.ksmlgl.avro.model.AvroHttpRequest.Builder newBuilder(com.ksmlgl.avro.model.AvroHttpRequest other) {
    return new com.ksmlgl.avro.model.AvroHttpRequest.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroHttpRequest>
    ...
    private com.ksmlgl.avro.model.ClientIdentifier clientIdentifier;
    private com.ksmlgl.avro.model.ClientIdentifier.Builder clientIdentifierBuilder;
    private java.util.List<java.lang.CharSequence> employeeNames;
    private com.ksmlgl.avro.model.Active active;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ksmlgl.avro.model.AvroHttpRequest.Builder other) {
      super(other);
      if (isValidValue(fields()[0], other.requestTimes)) {
        this.requestTimes = data().deepCopy(fields()[0].schema(), other.requestTimes);
      ...
      if (other.hasClientIdentifierBuilder()) {
        this.clientIdentifierBuilder = com.ksmlgl.avro.model.ClientIdentifier.newBuilder(other.getClientIdentifierBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ksmlgl.avro.model.AvroHttpRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.requestTimes)) {
        this.requestTimes = data().deepCopy(fields()[0].schema(), other.requestTimes);
        fieldSetFlags()[0] = true;
    ...
    /**
      * Sets the value of the 'requestTimes' field.
      * @param value The value of 'requestTimes'.
      * @return This builder.
      */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder setRequestTimes(long value) {
    ...
    /**
      * Checks whether the 'requestTimes' field has been set.
      * @return True if the 'requestTimes' field has been set, false otherwise.
      */
    ...
    /**
      * Clears the value of the 'requestTimes' field.
      * @return This builder.
      */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder clearRequestTimes() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder setClientIdentifier(com.ksmlgl.avro.model.ClientIdentifier value) {
     ...
     * @return This builder.
     */
    public com.ksmlgl.avro.model.ClientIdentifier.Builder getClientIdentifierBuilder() {
      if (clientIdentifierBuilder == null) {
        if (hasClientIdentifier()) {
          setClientIdentifierBuilder(com.ksmlgl.avro.model.ClientIdentifier.newBuilder(clientIdentifier));
        } else {
          setClientIdentifierBuilder(com.ksmlgl.avro.model.ClientIdentifier.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder setClientIdentifierBuilder(com.ksmlgl.avro.model.ClientIdentifier.Builder value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder clearClientIdentifier() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder setEmployeeNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder clearEmployeeNames() {
      employeeNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder setActive(com.ksmlgl.avro.model.Active value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ksmlgl.avro.model.AvroHttpRequest.Builder clearActive() {
      active = null;
    ...
    public AvroHttpRequest build() {
      try {
        ...
        record.requestTimes = fieldSetFlags()[0] ? this.requestTimes : (java.lang.Long) defaultValue(fields()[0]);
        if (clientIdentifierBuilder != null) {
          record.clientIdentifier = this.clientIdentifierBuilder.build();
        } else {
          record.clientIdentifier = fieldSetFlags()[1] ? this.clientIdentifier : (com.ksmlgl.avro.model.ClientIdentifier) defaultValue(fields()[1]);
        }
        record.employeeNames = fieldSetFlags()[2] ? this.employeeNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[2]);
        record.active = fieldSetFlags()[3] ? this.active : (com.ksmlgl.avro.model.Active) defaultValue(fields()[3]);
        return record;
